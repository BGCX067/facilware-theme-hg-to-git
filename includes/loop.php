	...
	<div class="post-content">
		...
		<?php if($hide_meta != 'yes'): ?>
			<div class="post-meta">		
 				...
 				<span class="post-author"><?php _e( 'Por', 'themify' ); ?> <?php echo '<span style="color:#d2842c">'.get_the_author().'</span>' ?> </span>
				<span class="post-category">en <?php echo '<span style="color:#d2842c"> '.the_category(', ').'</span>' ?> </span>
				<?php if(comments_open()) : ?>
					<span class="post-comment"><img class="imgpostmeta" src="wp-content/themes/itheme2/images/postmeta/comments.png" /><?php comments_popup_link('Sin comentarios', '1 comentario', '% comentarios');  ?></span>
